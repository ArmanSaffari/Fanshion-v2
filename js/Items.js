    ...
    products.forEach((product, index) => {
      ...
      if (product.badges && product.badges.length > 0) {
        product.badges.forEach((badge) => {
          badgesList += `<span class="badge filled-pink ">${badge}</span>`
        });
      }
      ...
      for (let i = 0; i < 5; i++) {
        ...
        `<img width="20px" height="20px" src="./assets/Page 6/star-filled.svg" />` :
        `<img width="20px" height="20px" src="./assets/Page 6/star-blank.svg" />`
      }
      ...
      if (product.reviews && product.reviews.length > 0) {
        ...
        product.reviews.forEach((review) => {
          ...
          for (let j = 0; j < 5; j++) {
            ...
            `<img width="15px" height="15px" src="./assets/Page 6/star-filled.svg" />` :
            `<img width="15px" height="15px" src="./assets/Page 6/star-blank.svg" />`
          }


          reviews += `
          <p class="d-inline"><span><img src="./assets/Page 6/personIcon.svg" /></span>${review.author}<span class="text-black-50 mx-3" style="font-size: 12px">${review.timestamp}</span></p>
      ...
      <div class="card border border-dark rounded-3">
        <div class="row m-0" style="height: 400px;">
          <div class="border border-dark rounded-3 col-5 p-0 h-100">
            <a href="./itemDetails.html" style="text-decoration: none;">
